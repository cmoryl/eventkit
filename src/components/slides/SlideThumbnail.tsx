...
export function SlideThumbnail({ slideNumber, isActive = false, onClick, children }: SlideThumbnailProps) {
  return (
    <div className="group relative">
      <div className="flex items-start gap-2">
        ...
        <div
          className={cn(
            'relative flex-1 aspect-video bg-white dark:bg-slate-900 rounded-md overflow-hidden border cursor-pointer',
