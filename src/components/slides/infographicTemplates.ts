...
export const INFOGRAPHIC_TEMPLATES: InfographicTemplate[] = [
  ...
  {
    id: 'stat-grid-4',
    name: '4-Up KPI Grid (BrandHub)',
    category: 'stats',
    description: 'Four KPIs in graduated tint cards — TransPerfect "By the Numbers" look',
    tags: ['kpi', 'metrics', 'dashboard', 'grid', 'brandhub', 'tiles'],
    animated: true,
    theme: 'transperfect',
    slide: {
      layout: 'stats',
      variation: 'brandhub-tiles',
      title: 'The signals that matter',
      variant: 'brand',
      stats: [
        { value: '200+',  label: 'Languages — across 140 countries' },
        { value: '5B',    label: 'Words / yr — up from 3.8B in 2024' },
        { value: '98%',   label: 'On-time — Enterprise SLA met' },
        { value: '10k+',  label: 'Linguists — ISO 17100 certified' },
      ],
    },
  },
  {
  ...
  // ── Charts ───────────────────────────────────────────────────────
  {
    ...
    name: 'Growth Bars (BrandHub)',
    category: 'charts',
    description: 'TransPerfect-style gradient growth bars with trend overlay',
    tags: ['bar', 'growth', 'revenue', 'chart', 'brandhub', 'transperfect'],
    animated: true,
    theme: 'transperfect',
    slide: {
      layout: 'chart',
      variation: 'growth-bars',
      title: 'Words translated (B)',
      variant: 'brand',
      chart: {
        type: 'bar',
        title: 'Annual translation volume',
        data: [
          { label: '\u201922', value: 2.1 },
          { label: '\u201923', value: 3.0 },
          { label: '\u201924', value: 3.8 },
