...
export const INFOGRAPHIC_TEMPLATES: InfographicTemplate[] = [
  ...
  },
  {
    ...
    slide: {
      ...
      variant: 'brand',
      stats: [
        { value: '200+',  label: 'Languages',  sublabel: 'Across 140 countries' },
        { value: '5B',    label: 'Words / yr', sublabel: 'Up from 3.8B in 2024' },
        { value: '98%',   label: 'On-time',    sublabel: 'Enterprise SLA met' },
        { value: '10k+',  label: 'Linguists',  sublabel: 'ISO 17100 certified' },
      ],
    },
  },
  {
